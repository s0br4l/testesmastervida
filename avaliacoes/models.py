...
class Dexa(models.Model):
    ...
    Area_Total__cm3 = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    BMD_L__Arm = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    BMD_R_Arm = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    BMD_L__Ribs = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    ...
    BMD_L__Spine = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    BMD_Pelves = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    BMD_L__Leg = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
